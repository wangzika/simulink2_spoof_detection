...
| PASS | Regular paper length | Approximate manuscript word count is 5000. |  |
...
| PASS | Reference coverage | 16 bibliography entries in the compiled draft. |  |
